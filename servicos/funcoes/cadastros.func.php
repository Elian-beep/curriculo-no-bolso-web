...
{
    $sql = "INSERT INTO formacoes (instituicao, curso, inicio ,termino, id_tipo, id_usuario, id_curriculo) VALUES ('$instituicao', '$curso', '$inicio' , '$termino', '$id_tipo', '$id_usuario', '$id_curr');";
    $conexao->query($sql);
...
function CadastrarExperiencia($empresa, $cargo, $inicio, $termino, $descricao, $id_usuario, $id_curr, $conexao)
{
    ...
    $sql = "INSERT INTO experiencias (empresa, cargo, inicio ,termino, descricao, id_usuario, id_curriculo) VALUES ('$empresa', '$cargo', '$inicio' , '$termino', '$descricao', '$id_usuario', '$id_curr');";
    $conexao->query($sql);
...
{
    $sql = "INSERT INTO certificacoes (instituicao, curso, termino, descricao, id_usuario, id_curriculo) VALUES ('$instituicao', '$curso', '$termino', '$descricao', '$id_usuario', '$id_curr');";
    $conexao->query($sql);
...
function CadastrarPremiacao($instituicao, $premiacao, $ano_premiacao, $descricao, $id_usuario, $id_curr, $conexao)
{
    ...
    $sql = "INSERT INTO premiacoes (instituicao, premiacao, ano_premiacao , descricao, id_usuario, id_curriculo) VALUES ('$instituicao', '$premiacao', $ano_premiacao, '$descricao', '$id_usuario', '$id_curr');";
    $conexao->query($sql);
